...
const firstInRow = (entity_address, props) => {
  ...
  let sectionEntity = address.byPath(props.form, entity_address.slice(0, entity_address.length - 1))
  ...
  drop_handler: (event, props) => {
    ...
    if (data.action === 'addEntity') {
      ...
      if (offsetGrids <= props.model.prepend()) {
        ...
        console.log('add this entity: ', destinationAddress, address.resurrectEntity(
          Object.assign({},
            data.model, {
              prepend: offsetGrids,
        ...
        props.add(destinationAddress, address.resurrectEntity(
          Object.assign({},
            data.model, {
              prepend: offsetGrids,
              append: (props.model.prepend() - offsetGrids - data.model.width)
