              ...
              <table>
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input type="checkbox" name="min-inclusive" checked="checked" id="min-inclusive" />
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="checkbox" name="max-inclusive" checked="checked" id="max-inclusive" />
                      <label for="max-inclusive">Max Inclusive</label>
                    </td>
                  </tr>
                </tbody>
              </table>
              <input type="checkbox" name="validState" checked="checked" id="validState-range" />
              <label for="validState-range">
                If checked values matching the (pattern, values, range) above satisfy the condition.
              </label>
              <br />
              <input type="checkbox" name="nullIsValid" checked="checked" id="nullIsValid-range" />
