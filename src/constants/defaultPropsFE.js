...
export const defaultPropsFE = {
  ...
  Form: (new Form({ uuid: 10, type: 'TextInput', version: 1, autoId: true, children: [], crf: 'crf', inputs: ['input1', 'input2'], remoteValidatorCondition: { 0: 'zero', 1: 'one' }, sectionTabs: false, versionDescription: 'version description' })),

  FormSection: (new FormSection({uuid: 1, type: 'FormSection', width: 2, children: ['children'], legend: 'string', prepend: 3, append: 4})),
