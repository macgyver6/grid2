      ...
      new FormSection({
        uuid: undefined, type: 'FormSection', width: 24, children: [
            ...
            uuid: undefined, type: 'FormSection', width: 18, children: [
              new TextInput({
                uuid: undefined, prepend: 5, width: 6, append: 7, prePrompt: 'prePromptString', prePromptWidth: 6, postPrompt: 'postPromptString', postPromptWidth: 6, name: 'text input name', sasCodeLabel: 'sasCodeLabel', type: 'TextInput', tabOrder: [1, 2, 3], inputWidth: 8, promptNumber: 'promptNumber', autoNumber: 'SEQUENTIAL', length: 'DEFAULT', autoTab: true, doubleEntry: true, defaultContent: 'Default Content',
          ...
          new FormSection({
            uuid: undefined, type: 'FormSection', width: 16, children: [
              new TextInput({
                uuid: undefined, prepend: 0, width: 5, append: 4, prePrompt: 'prePromptString', prePromptWidth: 6, postPrompt: 'postPromptString', postPromptWidth: 6, name: 'text input name', sasCodeLabel: 'sasCodeLabel', type: 'TextInput', tabOrder: [1, 2, 3], inputWidth: 8, promptNumber: 'promptNumber', autoNumber: 'SEQUENTIAL', length: 'DEFAULT', autoTab: true, doubleEntry: true, defaultContent: 'Default Content',
                render: { backgroundColor: '#6C788F', minWidth: 3 }
              }),
              new TextInput({
                uuid: undefined, prepend: 0, width: 5, append: 2, prePrompt: 'prePromptString', prePromptWidth: 6, postPrompt: 'postPromptString', postPromptWidth: 6, name: 'text input name', sasCodeLabel: 'sasCodeLabel', type: 'TextInput', tabOrder: [1, 2, 3], inputWidth: 8, promptNumber: 'promptNumber', autoNumber: 'SEQUENTIAL', length: 'DEFAULT', autoTab: true, doubleEntry: true, defaultContent: 'Default Content',
                render: { backgroundColor: '#6C788F', minWidth: 3 }
              }),
              new TextInput({
                uuid: undefined, prepend: 0, width: 5, append: 4, prePrompt: 'prePromptString', prePromptWidth: 6, postPrompt: 'postPromptString', postPromptWidth: 6, name: 'text input name', sasCodeLabel: 'sasCodeLabel', type: 'TextInput', tabOrder: [1, 2, 3], inputWidth: 8, promptNumber: 'promptNumber', autoNumber: 'SEQUENTIAL', length: 'DEFAULT', autoTab: true, doubleEntry: true, defaultContent: 'Default Content',
          ...
          new FormSection({
            uuid: undefined, type: 'FormSection', width: 24, children: [
              // new TextInput({
              //   uuid: undefined, width: 6, prePrompt: 'prePromptString', prePromptWidth: 6, postPrompt: 'postPromptString', postPromptWidth: 6, name: 'text input name', sasCodeLabel: 'sasCodeLabel', type: 'TextInput', tabOrder: [1, 2, 3], inputWidth: 8, promptNumber: 'promptNumber', prepend: 9, autoNumber: 'SEQUENTIAL', append: 9, length: 'DEFAULT', autoTab: true, doubleEntry: true, defaultContent: 'Default Content',
              //   render: { backgroundColor: '#6C788F', minWidth: 3 }
              // }),
              // new TextArea({
