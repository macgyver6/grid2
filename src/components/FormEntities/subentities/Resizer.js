...
let Resizer = (props) => {
  ...
  let mouseUp_handler = function (event) {
    ...
    console.log('change this: ', entityToChangeColor.id + 'to: ' + defaultPropsFE[props.model.type()].render.backgroundColor)
    entityToChangeColor.style.backgroundColor = defaultPropsFE[props.model.type()].render.backgroundColor
  }
